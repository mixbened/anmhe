<template>
  ...
  <section class="my-8 mx-auto w-full sm:w-4/5 md:w-4/5 lg:w-2/3 xxl:w-1/3 p-8">
    <form action="https://aintnomountain.us2.list-manage.com/subscribe/post?u=379cbb28ae2ca785a28d16826&amp;id=82123e83a3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
      <div class="grid grid-cols-5">
        ...
        <div class="col-span-3">
          <h2 class="">Newsletter abbonieren</h2>
          <h2 class="text-3xl font-semibold">Kein Event mehr verpassen</h2>
        ...
        <div class="col-span-4 -mt-24 ml-10">
          <div class="mc-field-group h-10">
          <input type="email" value="" name="EMAIL" class="required email w-full p-2 text-black bg-gray-200 h-full" id="mce-EMAIL" placeholder="Email Adresse">
          </div>
        </div>
        <div class="col-span-1 -mt-24">
          <div class="clear h-10"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="cursor-pointer h-full w-full bg-secondary hover:bg-black text-white font-bold py-2 px-4 text-sm"></div>
        ...
        <div class="col-span-5 text-sm -mt-4 leading-tight">
